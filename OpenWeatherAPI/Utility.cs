...
namespace OpenWeatherAPI
{
	...
	public static class ExcludeEnum
	{
		...
		public static string Minutely { get; } = "minutely";
		public static string Hourly { get; } = "hourly";
		public static string Daily { get; } = "daily";
		public static string Alerts { get; } = "alerts";
	}
	...
	public static class Utility
	{
		...
		public static DirectionEnum assignDirection(double degree)
		{
		...
		//fB = fallsBetween
		public static bool fB(double val, double min, double max)
		{
			if ((min <= val) && (val <= max))
				return true;
			return false;
